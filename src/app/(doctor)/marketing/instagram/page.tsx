                ...
                <div className="flex items-center justify-between">
                  ...
                  {scheduledAt && !marked && (
                    <div className="flex items-center gap-2">
                      ...
                      <Link href="/marketing/calendario" className="text-xs font-semibold text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-200 hover:underline flex items-center gap-1">
                        Ver calendario
