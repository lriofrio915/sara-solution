...
export default function RegisterForm({ referralCode }: Props) {
  ...
  return (
    <>
      ...
      {/* Referral banner */}
      {referralCode && (
        <div className="mb-6 p-4 bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 rounded-xl flex items-start gap-3">
          <div className="w-9 h-9 bg-primary/15 rounded-xl flex items-center justify-center flex-shrink-0">
            <Gift size={18} className="text-primary" />
          </div>
          <div>
            <p className="text-sm font-semibold text-gray-900">Fuiste invitado por un colega</p>
            <p className="text-sm text-gray-600 mt-0.5">
              Al suscribirte a un plan Pro, <strong>ambos ganan 1 mes gratis</strong> de acceso a Sara Medical. ¡El beneficio se aplica automáticamente!
            </p>
          </div>
        </div>
      )}
