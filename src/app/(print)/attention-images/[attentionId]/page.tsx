...
export default async function AttentionImagesPrintPage(props: { params: Promise<{ attentionId: string }> }) {
      ...
      <div className="bg-gray-100 min-h-screen py-8 px-4 print:bg-white print:p-0">
        <div className="bg-white max-w-[794px] mx-auto shadow-lg rounded-lg overflow-hidden print:shadow-none">
          ...
          <div className="px-8 py-4 text-center border-b border-gray-200">
            <h2 className="font-bold text-gray-900 text-xl uppercase tracking-wider">Orden de Imágenes Diagnósticas</h2>
          </div>
          ...
          <div className="px-8 py-6 space-y-5">
            ...
            {selectedImages.length > 0 ? (
              ...
              <p className="text-gray-400 text-sm text-center py-8">No hay imágenes diagnósticas seleccionadas.</p>
            )}
