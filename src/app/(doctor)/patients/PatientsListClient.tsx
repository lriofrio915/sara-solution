...
export default function PatientsListClient({
  ...
  // Los datos de la primera pantalla llegan ya renderizados desde el servidor: no se
  // vuelven a pedir al montar, que era el segundo viaje que hacía lenta la navegación.
  ...
  // La búsqueda sí pasa por el API. El primer efecto se salta porque el estado inicial
  // ya es la respuesta del servidor para la búsqueda vacía.
