...
export default function DoctorSidebar({ firstName, specialty, initials, avatarUrl, isSuperAdmin, plan, trialDaysLeft, role = 'OWNER', activeDoctorId, assistantDoctors }: Props) {
  ...
  const BellBadge = () => (
    <div ref={bellRef} className="relative">
      ...
      {bellOpen && (
        <div className="absolute left-0 top-10 z-50 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 overflow-hidden">
