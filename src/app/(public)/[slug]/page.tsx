    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 overflow-x-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                ...
                {doctor.whatsapp && (
                  <a
                    href={`https://wa.me/${doctor.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent(`Hola ${displayName}, vi su página y quisiera agendar una cita.`)}`}
                    target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2.5 font-bold px-8 py-4 rounded-2xl shadow-lg hover:opacity-90 transition-all hover:-translate-y-0.5 text-base text-white"
              ...
              {servicesList.map((service, i) => (
                <div key={i}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {service.price && (
                      <p className="text-blue-600 text-sm font-bold mt-1.5">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 shadow-2xl px-4 py-3 flex gap-3">
        <Link
          ...
          className="flex-1 flex items-center justify-center gap-2 text-white font-bold py-3 rounded-2xl text-sm shadow-md"
          style={{ background: 'linear-gradient(135deg, #2563EB 0%, #0D9488 100%)' }}
        >
