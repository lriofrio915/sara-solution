...
export default function AtencionesListClient({
  initialItems,
  initialTotal,
}: {
  initialItems: Attention[]
  initialTotal: number
}) {
  const router = useRouter()
  // La primera página llega renderizada desde el servidor; solo se vuelve a consultar
  // cuando el usuario busca, filtra o pagina.
  const [items, setItems] = useState<Attention[]>(initialItems)
  ...
  // Debounce de la búsqueda para no disparar una query por tecla. El primer efecto se
  // salta: el estado inicial ya es la respuesta del servidor para los filtros vacíos.
